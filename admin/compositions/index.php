...
if ($matchId) {
    $stmt = $pdo->prepare("
        ...
        JOIN joueurs j ON j.id = co.joueur_id
        WHERE co.match_id = ?
        ORDER BY co.type_joueur, j.poste, j.nom
    ");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Ne compter que les sélections valides (type reconnu + joueur convoqué)
    $nbTitulaires = 0;
    $nbRemplacants = 0;
...
$pageTitle = 'Compositions d\'équipe';
require_once ROOT_PATH . '/admin/includes/header.php';
?>

<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0">Compositions</h4>
</div>
...
<form method="POST">
    ...
    <div class="d-flex gap-2 justify-content-end mt-4">
        <button type="submit" class="btn btn-success"><i class="bi bi-check2 me-1"></i> Enregistrer la composition</button>
    </div>
</form>
...
<?php else: ?>
    <div class="text-center py-5 text-muted">
        ...
        Sélectionnez un match pour gérer sa composition.
    </div>
<?php endif; ?>
