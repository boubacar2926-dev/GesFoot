...
$pageTitle = 'Performances individuelles';
require_once __DIR__ . '/includes/header.php';
?>

<div class="mb-4">
    <h4 class="fw-bold mb-0">Performances individuelles</h4>
</div>
        ...
        <table class="table datatable mb-0">
            ...
            <tr>
                ...
                <td class="text-center">
                    <?php if ($j['note_moy']): ?>
                        <span class="badge <?= $j['note_moy']>=7?'bg-success':($j['note_moy']>=5?'bg-warning text-dark':'bg-danger') ?>">
                            <?= $j['note_moy'] ?>
                        </span>
                    <?php else: ?>—<?php endif; ?>
                </td>
            ...
            <?php endforeach; ?>
            <?php if (!$performances): ?>
            <tr><td colspan="9" class="text-center py-5 text-muted"><i class="bi bi-bar-chart fs-2 d-block mb-2"></i>Aucune donnée</td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </div>
